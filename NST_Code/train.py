...
def parse_arguments():
    ...
    parser.add_argument('--content_dir', type=str, default=str(current_dir / 'content_data'),
                        help='Location of content dataset')
    parser.add_argument('--style_dir', type=str, default=str(current_dir / 'style_data'),
                        help='Location of style dataset')
    parser.add_argument('--vgg', type=str, default=str(current_dir / 'vgg_normalised.pth'),
...
def main():
    ...
    current_dir = Path(__file__).resolve().parent
    save_dir = current_dir / 'experiment' / args.experiment
